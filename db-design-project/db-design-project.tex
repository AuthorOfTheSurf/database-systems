...
A primary index should be placed on \textbf{sale\_id} and \textbf{g\_sku} as physical indexes here will improve search times for individual elements. This will also make the joins between Purchase and Good through Line_Item quicker.
